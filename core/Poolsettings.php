<?php
	...
	// Feb, 19/2020
	// Building class for Poolsettings
	*/
	...
	class Poolsettings
	{
		...
		function __construct(Subscriber $subscriber)
		{
			...
			$res = $db->query("SELECT * FROM poolsettings");
		...
		public function Save()
		{
			...
			if($res = $db->query("SELECT * FROM poolsettings")->num_rows > 0)
			{
				$db->query("UPDATE poolsettings SET receipttemplate='$receipttemplate',papertype='$papertype',lowstockemail='$lowstockemail',lowstockphone='$lowstockphone',onlineorderphone='$onlineorderphone',receiptaddress='$receiptaddress',receiptemail='$receiptemail',receiptlogo='$receiptlogo',receiptsalutation='$receiptsalutation',cash='$cash',pos='$pos',online='$online',others='$others',refund='$refund',compundtax='$compundtax',salutation='$salutation'");
			}
			else
			{
				$db->query("INSERT INTO poolsettings(receipttemplate,papertype,lowstockemail,lowstockphone,onlineorderphone,receiptaddress,receiptemail,receiptlogo,receiptsalutation,cash,pos,online,others,refund,compundtax,salutation) VALUES ('$receipttemplate','$papertype','$lowstockemail','$lowstockphone','$onlineorderphone','$receiptaddress','$receiptemail','$receiptlogo','$receiptsalutation','$cash','$pos','$online','$others','$refund','$compundtax','$salutation')");
			}
		}
		...
		public function Delete()
		{
			...
			$db->query("DELETE FROM poolsettings");
		}
	}
