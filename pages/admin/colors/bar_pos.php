<?php
    ...
    $settings = new Barsettings($subscriber);
    ...
    $ret->Content = "
            ...
            <html>
                <head>
                    ...
                    <title>Bar POS . : ".$subscriber->BusinessName."</title>
					...
					<script type='application/javascript' src='".$cdn."js/barpos.js'></script>
                ...
                <body style=''>
									...
									<thead>
										<tr>
											<td colspan='6'>
												...
												<button class='ui right floated labeled circular basic green icon sleak button'>
												<i class='plus icon'></i> Tab</button>
					...
					<input id='pos-type' type='hidden' value='bar_item'/>
