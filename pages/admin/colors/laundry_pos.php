<?php
    ...
    $settings = new Laundrysettings($subscriber);
    ...
    else if(($user->Id != "") && ($user->Role->Laundrypos->WriteAccess))
    {
    ...
    $ret->Content = "
            ...
            <html>
                <head>
                    ...
                    <title>Laundry POS . : ".$subscriber->BusinessName."</title>
					...
					<script type='application/javascript' src='".$cdn."js/laundrypos.js'></script>
                ...
                <body style=''>
                    <div>
                        <div class='w3-container' style='padding: 4px; background-color: rgb(0,100,140); color: white;'>
							...
							<span style='color: lightgray;'>Laundry</span>
                        </div>
                    </div>
                    <div>
                            ...
                            <div class='l-width-8' style='margin: auto;'>
                                <div class='w3-row'>
									...
									<div class='w3-col l1 m1 s3'>
										<img src='".$host."cdn/images/icons/pastel/iron.png' style='width: 60px;'/>
									</div>
									<div class='w3-col l6 m6 s6'>
										<div style='padding-top: 10px;'>
											<div class='ui fluid large search'>
												<div id='sPrompt-con' class='ui fluid icon input'>
													<input id='sPrompt' class='prompt' type='text' placeholder='Item Name'
										...
										<tr>
											<td colspan='6'>
												<button class='ui right floated circular sleak green button'
														onclick='emptyTray()'>Empty Laundry Basket</button>
										...
										<tr>
											<td colspan='5'>
												<h3 class='sleak pad-2' style='color: silver;'>
													<i class='factory circular blue-text icon'></i> Laundry Basket is empty
												</h3>
											</td>
										</tr>
									</tbody>
					...
					<input id='pos-type' type='hidden' value='laundry_item'/>
