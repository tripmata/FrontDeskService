<?php
    ...
    $settings = new Poolsettings($subscriber);
    ...
    else if(($user->Id != "") && ($user->Role->Poolpos->WriteAccess))
    {
    ...
    $ret->Content = "
            ...
            <html>
                <head>
                    ...
                    <title>Pool POS . : ".$subscriber->BusinessName."</title>
					...
					<script type='application/javascript' src='".$cdn."js/poolpos.js'></script>
                ...
                <body style=''>
                    <div>
                        <div class='w3-container' style='padding: 4px; background-color: rgb(0,100,140); color: white;'>
							...
							<span style='color: lightgray;'>Swimming pool</span>
                        </div>
                    </div>
                    <div>
                            ...
                            <div class='l-width-8' style='margin: auto;'>
                                <div class='w3-row'>
									...
									<div class='w3-col l1 m1 s3'>
										<img src='".$host."cdn/images/icons/pastel/float.png' style='width: 60px;'/>
									</div>
										...
										<tr>
											<td colspan='6'>
												<button class='ui right floated circular sleak green button'
														onclick='emptyTray()'>Empty Pool Session</button>
										...
										<tr>
											<td colspan='5'>
												<h3 class='sleak pad-2' style='color: silver;'>
													<i class='life ring outline  circular blue-text icon'></i> Pool session is empty
												</h3>
											</td>
										</tr>
									</tbody>
					...
					<input id='pos-type' type='hidden' value='pool_item'/>
