        ...
        $ret->Content = "<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <meta name='description' content='".Seo::Metadescription($subscriber, $seo->Homedescription, Seo::Aboutus)."'/>
                    <meta name='keywords' content='".Seo::MetaKeywords($subscriber, $seo->Homekeywords, Seo::Aboutus)."'/>
                    
                    <!-- End Seo -->
            
                    
                    <title>".Seo::BuildTitle($subscriber,"About Us | " . $subscriber->BusinessName, Seo::Aboutus)."</title>
                ...
                $ret->Content .= "
                    <div class='l-width-8' style='margin: auto;'>
                        <div class='l-margin-t-3 s-pad-1'>
                            <h5 style='color: dimgray; font-family: ".$site->BoldFont.";'>
                                ...
                                ".$site->PrimaryColor.";'>
                                <i class='group icon'></i></div> About Us
                            </h5><hr>
                            <div class='ui breadcrumb' style='font-family: ".$site->SecondaryFont.";'>
                              <a class='section'>Home</a>
                              <i class='right chevron icon divider'></i>
                              <div class='section' style='color: black; font-family: ".$site->SecondaryFont.";'>About Us</div>
                            </div>
                            <div class='w3-row'>
                    ...
                    {
                        try {
                            $html = str_get_html(strval($site->Aboutus));
