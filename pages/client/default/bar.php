<?php
    ...
    else
    {
        ...
        $ret->Content = "<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <meta name='description' content='".Seo::Metadescription($subscriber, $seo->Bardescription, Seo::Bar)."'/>
                    <meta name='keywords' content='".Seo::MetaKeywords($subscriber, $seo->Barkeywords, Seo::Bar)."'/>
                    
                    <!-- End Seo -->
                    
                    <title>".Seo::BuildTitle($subscriber,"Bar | " . $subscriber->BusinessName, Seo::Bar)."</title>
        ...
        $ret->Content .= "
                    <div class='pad-2' style=' background-image: url(".$host."/cdn/themes/default/images/bar_back.jpg".");
                    background-position: center; background-repeat: no-repeat; background-size: cover;'>
                         <div class='l-width-8' style='margin: auto;'>
                            <div class='l-margin-t-3'>
                                <div class='w3-row'>
                                    <div class='w3-col l1 m1 s2'>
                                        <img src='".$host."/cdn/images/icons/pastel/glass_cups.png' style='width: 65px; max-width: 100%;'/>
                                    </div>
                                ...
                                <div class='ui white-text breadcrumb'>
                                  ...
                                  <div class='section' style='font-family: ".$site->SecondaryFont."'>Bar</div>
                                </div>
                            </div>
                        </div>
                    </div>";
                    ...
                    $drinkcat = Drinkcategory::Order($subscriber, 'sort', 'DESC');

                    $catvalidlist = [];

                    for($i = 0; $i < count($drinkcat); $i++)
                    {
                        if($drinkcat[$i]->Status)
                        {
                            array_push($catvalidlist, $drinkcat[$i]);
                        }
                    }
                    ...
                    $ret->Content .=
                        "<div class='l-hide'>
                            <div class='pad-1' style='background-color: rgb(250,251,255);'>
                                <div class='ui fluid search large drink-search margin-t-1'>
                                    <div class='ui fluid icon input'>
                                        <input class='prompt' type='text' placeholder='Search drinks'>
                ...
                $cat = Drinkcategory::ByMeta($subscriber, $catt);

                $drink = Drink::Bycategory($subscriber, $cat, 'sort', 'DESC');
                        ...
                        <div class='w3-col l8 m8 s12 s-margin-b-1'>
                            <div class='margin-t-2' style=''>
                                ...
                                <div class='l-width-8 pad-1' style='margin: auto;'>
                                    ...
                                    <h5 style='font-family: ".$site->TextFont."; color: dimgray;'>
                                        ...
                                        ((($pagenum * 12) < count($drink)) ? ($pagenum * 12) : count($drink))
                                        ." of ".count($drink)."
                                    </h5>
                                </div>
                                ...
                                for($i = (($pagenum - 1) * 12); $i < count($drink); $i++)
                                {
                                    if($drink[$i]->Status)
                                    {
                                        $ret->Content .= "<div class='w3-col l4 m4 s6'>
                                            <div class='l-width-9 s-pad-t' style='margin: auto;'>
                                                <div class='widget margin-t-2 hover-item' style='cursor: pointer;' onclick=\"reserveDrink('".$drink[$i]->Id."')\">
                                                    <div style='position: relative;'>
                                                        <img src='".Router::ResolvePath("files/" . $drink[$i]->Images[0], $path)."' style='width: 100%; border-radius: 6px;'/>
                                                        ...
                                                        background: linear-gradient(to bottom, rgba(255,255,255,0), rgba(255,255,255,0), rgba(255,255,255,0), rgb(0,0,0));'>
                                                            <h6 style='color: white; bottom: 0px; left: 10px; font-family: ".$site->SecondaryFont."; position: absolute;'>
                                                                ...
                                                                number_format($drink[$i]->Price, 2)."
                                                                &nbsp;&nbsp;&nbsp;&nbsp;".
                                                                ($drink[$i]->Compareat > 0 ?  "<s>
                                                                <span style='font-family: Arial;'>".
                                                                $subscriber->Currency->Symbol."</span>".
                                                                number_format($drink[$i]->Compareat, 2)."</s>" : "")."
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    "<div>
                                        <div class='align-c'>
                                            <div class='ui compact menu pagination'>";
                                                ...
                                                if($pagenum > 1)
                                                {
                                                    $ret->Content .= "<a href='".Router::ResolvePath('bar/'.$category."/".($pagenum - 1), $path)."'
                                                ...
                                                for($i = 0; $i < $num; $i++)
                                                {
                                                    ...
                                                    {
                                                        $ret->Content .= "<a href='".Router::ResolvePath('bar/'.$category."/".($i + 1), $path)."' 
                            ...
                            <div class='w3-col l4 m4 s12'>
                                <div class='l-width-7' style='margin-top: 50px;'>";
                                    ...
                                    "<div class='s-hide'>
                                        <div class='pad-1' style='background-color: rgb(250,251,255);'>
                                            <div class='ui drink-search fluid search'>
                                        ...
                                        $ret->Content .=
                                            "<div class='s-hide' style='margin-top: 10px; background-color: rgb(250,251,255);'>
                                                ...
                                                <div>
                                                    ...
                                                    $ret->Content .=
                                                        "<a href='".Router::ResolvePath('bar/all/1', $path)."'>
                                                    ...
                                                    {
                                                        $ret->Content .=
                                                        "<a href='".Router::ResolvePath('bar/'.$catvalidlist[$j]->Meta.'/1', $path)."'>
                                                            <div class='pad-1 hoverable'            
                                                                style='border-bottom: 1px solid whitesmoke; 
                                                                cursor: pointer;'>
                                                                <h6 style='font-family: ".$site->TextFont.";'>
                                        ...
                                        $ret->Content .=
                                            "<div style='margin-top: 10px; background-color: rgb(250,251,255);'>
                                                ...
                                                <div>
                                                    ...
                                                    $popular = Drink::ByPopularity($subscriber);

                                                    for($j = 0; $j < count($popular); $j++)
                                                    {
                                                        $ret->Content .= "
                                                        <div class='w3-row hover-item' style='cursor: pointer;' onclick=\"reserveDrink('".$popular[$i]->Id."')\">
