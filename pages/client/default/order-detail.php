                        ...
                        $ret->Content .="
                            <div class='w3-col l4 m4 s12'>
                                ...
                                else
                                {
                                    ...
                                    {
                                        $ret->Content .=
                                                "<div id='online-btn' class='ui left labeled button s-margin-t-1 s-margin-b-2' tabindex='0' onclick='beginPayonline()'>
                                                    <a class='ui basic right pointing label' 
                                                    style='border: 1px solid ".$site->PrimaryColor."; color: ".$site->PrimaryColor.";'>
                                                        <i id='online-btn-icon' class='credit card icon'></i>
                                                    </a>
                                                    <div id='online-btn-text' class='ui button' style='background-color: ".$site->PrimaryColor."; color: white; font-weight: normal;'>
                                                        Pay now
                                                    </div>
                                                </div>";
