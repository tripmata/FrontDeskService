        ...
        $ret->Content = "<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <meta name='description' content='".Seo::Metadescription($subscriber, $seo->Homedescription, Seo::Privacy)."'/>
                    <meta name='keywords' content='".Seo::MetaKeywords($subscriber, $seo->Homekeywords, Seo::Privacy)."'/>
                    
                    <!-- End Seo -->
                    
                    <title>".Seo::BuildTitle($subscriber,"Privacy policy | " . $subscriber->BusinessName, Seo::Privacy)."</title>
                ...
                {
                    try {
                        $html = str_get_html(strval($site->Privacypolicy));
