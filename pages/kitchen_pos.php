<?php
    ...
    $settings = new Kitchensettings($subscriber);
    ...
    else if(($user->Id != "") && ($user->Role->Kitchenpos->WriteAccess))
    {
    ...
    $ret->Content = "
            ...
            <html>
                <head>
					...
					<script type='application/javascript' src='".$cdn."js/kitchenpos.js'></script>
                ...
                <body style=''>
                    ...
                    <div>
                        <div class='w3-container' style='padding: 4px; background-color: rgb(0,100,140); color: white;'>
							...
							<span style='color: lightgray;'>Kitchen / Restaurant</span>
                        </div>
                    </div>
                    <div>
                            ...
                            <div class='l-width-8' style='margin: auto;'>
                                <div class='w3-row'>
									...
									<div class='w3-col l1 m1 s3'>
										<img src='".$host."cdn/images/icons/pastel/turkey.png' style='width: 60px;'/>
									</div>
                                   ...
                                   <div class='w3-col l2 m1 s3 align-c right floated'>
										<button class='ui small  basic button' style='margin-top: 15px; cursor: pointer;'onclick='openFoodOrder()'>
											<i class='utensils red icon'></i> Food Orders
										</button>
									</div>
                                </div>
                            </div>
										...
										<tr>
											<td colspan='6'>
												<button class='ui right floated circular sleak green button'
														onclick='emptyTray()'>Empty Food Tray</button>
										...
										<tr>
											<td colspan='5'>
												<h3 class='sleak pad-2' style='color: silver;'>
													<i class='utensils circular blue-text icon'></i> Food Tray is empty
												</h3>
											</td>
										</tr>
									</tbody>
					...
					<input id='pos-type' type='hidden' value='kitchen_item'/>
